...
public class 크레인_인형뽑기_카카오 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(solution(boardSize, board, moveSize, moves));
    }

    private static int solution(int boardSize, int[][] board, int moveSize, int[] moves) {
        ...
        for (int move : moves) {
            for (int i = 0; i < boardSize; i++) {
                if(board[i][move-1] != 0){
                    ...
                    else bucket.push(board[i][move-1]);
                    board[i][move-1] = 0;
                    break;
                }
            }
